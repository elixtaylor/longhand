...
const additionalCases: Record<string, string> = {
  ...
  'expressions / expand': '(2x - 3)(x + 4)',
  'expressions / simplify': '2x + 3x - 4',
  'expressions / both': 'e^(1/2)(5 - 4e^(4/3))',
  ...
  'probability / intersection': 'P(A)=0.65, P(B)=0.4 independent intersection',
  'probability / conditional': 'P(A)=0.65, P(B)=0.4 independent given',
