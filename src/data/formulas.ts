...
export const FORMULAS: Record<string, Formula[]> = {
  linear: [
    {
      ...
      latex: 'ax + b = c \\;\\Rightarrow\\; x = \\dfrac{c-b}{a}',
    },
  ],
  simultaneous: [
    {
      name: 'Elimination',
      latex: '\\text{scale so a variable matches, then add or subtract}',
    },
    {
      name: 'Substitution',
      latex:
        '\\text{make } y \\text{ the subject of one equation, then substitute into the other}',
    },
  ],
  collect: [
  ...
  absolute: [
    {
      ...
      latex:
        '|x| = a \\;(a \\ge 0) \\;\\Rightarrow\\; x = a \\text{ or } x = -a',
    },
    {
      name: 'Equal magnitudes',
      latex: '|A| = |B| \\;\\Rightarrow\\; A = B \\text{ or } A = -B',
    },
  ],
  inverse: [
    {
      name: 'Undoing an equation',
      latex:
        '\\text{apply the inverse of each operation, working from the outside in}',
    },
    {
      name: 'Inverse operations',
      latex:
        '+ \\leftrightarrow -, \\quad \\times \\leftrightarrow \\div, \\quad x^{2} \\leftrightarrow \\sqrt{x}, \\quad e^{x} \\leftrightarrow \\ln x',
    },
  ],
  reduce: [
    {
      name: 'Removing a repeated function',
      latex:
        '\\sqrt{a} = \\sqrt{b} \\;\\Rightarrow\\; a = b, \\quad \\log a + \\log b = \\log(ab)',
    },
  ],
  quadratics: [
    {
  ...
  polynomials: [
    {
      ...
      latex: 'P(x) \\div (x - a) \\text{ leaves } P(a)',
    },
    {
      name: 'Factor theorem',
      latex: 'P(a) = 0 \\iff (x - a) \\text{ is a factor}',
    },
  ],
  indices: [
  ...
  logarithms: [
    ...
    {
      name: 'Quotient',
      latex: '\\log a - \\log b = \\log\\!\\left(\\dfrac{a}{b}\\right)',
    },
    { name: 'Power', latex: '\\log a^{n} = n\\log a' },
    {
      name: 'Change of base',
      latex: '\\log_{a} b = \\dfrac{\\log b}{\\log a}',
    },
  ],
  financial: [
  ...
  sequences: [
    ...
    {
      name: 'Arithmetic sum',
      latex: 'S_{n} = \\dfrac{n}{2}\\left(2a + (n-1)d\\right)',
    },
  ...
  measurement: [
    ...
    {
      name: 'Cone',
      latex: 'V = \\tfrac{1}{3}\\pi r^{2}h, \\quad SA = \\pi r^{2} + \\pi r l',
    },
  ...
  'trig-equations': [
    ...
    {
      name: 'Sine symmetry',
      latex: '\\sin(180^{\\circ} - \\theta) = \\sin\\theta',
    },
    {
      name: 'Cosine symmetry',
      latex: '\\cos(360^{\\circ} - \\theta) = \\cos\\theta',
    },
  ],
  differentiate: [
    {
      name: 'Power rule',
      latex: '\\dfrac{d}{dx}\\left(ax^{n}\\right) = nax^{\\,n-1}',
    },
    ...
    {
      name: 'Chain rule',
      latex: '\\dfrac{dy}{dx} = \\dfrac{dy}{du} \\times \\dfrac{du}{dx}',
    },
    {
  ...
  integrate: [
    {
      ...
      latex: '\\int ax^{n}\\,dx = \\dfrac{a}{n+1}x^{\\,n+1} + C',
    },
    {
  ...
  'calculus-applications': [
    ...
    {
      name: 'Nature of a stationary point',
      latex:
  ...
  rates: [
    {
      ...
      latex: '\\dfrac{dy}{dt} = ky \\;\\Rightarrow\\; y = y_{0}e^{kt}',
    },
  ...
  statistics: [
    { name: 'Mean', latex: '\\bar{x} = \\dfrac{\\sum x}{n}' },
    {
      ...
      latex: 's = \\sqrt{\\dfrac{\\sum (x - \\bar{x})^{2}}{n - 1}}',
    },
  ...
  distributions: [
    { name: 'Binomial', latex: 'P(X = x) = \\dbinom{n}{x}p^{x}(1-p)^{\\,n-x}' },
    {
      ...
      latex: '\\mu = np, \\quad \\sigma^{2} = np(1-p)',
    },
    { name: 'Standardising', latex: 'z = \\dfrac{x - \\mu}{\\sigma}' },
    {
      name: 'Confidence interval',
      latex: '\\bar{x} \\pm z^{*}\\dfrac{\\sigma}{\\sqrt{n}}',
    },
  ],
  complex: [
    ...
    {
      name: 'De Moivre',
      latex: 'z^{n} = r^{n}\\left(\\cos n\\theta + i\\sin n\\theta\\right)',
    },
  ],
  vectors: [
    {
      name: 'Magnitude',
      latex: '|\\mathbf{a}| = \\sqrt{a_{1}^{2} + a_{2}^{2} + a_{3}^{2}}',
    },
    {
      name: 'Dot product',
      latex:
  ...
  matrices: [
    ...
    {
      name: 'Singular',
      latex: '\\det A = 0 \\Rightarrow A^{-1} \\text{ does not exist}',
    },
  ],
  induction: [
    {
      ...
      latex:
        '\\text{base case} \\;\\to\\; \\text{assume } P(k) \\;\\to\\; \\text{show } P(k+1)',
    },
    {
    ...
    {
      name: 'Sum of squares',
      latex: '\\sum_{r=1}^{n} r^{2} = \\dfrac{n(n+1)(2n+1)}{6}',
    },
    {
      name: 'Sum of cubes',
      latex: '\\sum_{r=1}^{n} r^{3} = \\left(\\dfrac{n(n+1)}{2}\\right)^{2}',
    },
  ],
  functions: [
  ...
  percentages: [
    ...
    },
    {
      ...
      latex: '\\text{original} = \\dfrac{\\text{new}}{1 \\pm \\frac{p}{100}}',
    },
  ],
  fractions: [
    {
      name: 'Add or subtract',
      latex: '\\dfrac{a}{b} \\pm \\dfrac{c}{d} = \\dfrac{ad \\pm bc}{bd}',
    },
    {
      name: 'Multiply',
      latex: '\\dfrac{a}{b} \\times \\dfrac{c}{d} = \\dfrac{ac}{bd}',
    },
    {
      name: 'Divide',
      latex:
  ...
  inequalities: [
    { name: 'Sign flip', latex: 'a < b \\;\\Rightarrow\\; -a > -b' },
    {
      name: 'Quadratic',
      latex:
        '\\text{sketch, then read off where the curve is above/below the axis}',
    },
  ],
  networks: [
