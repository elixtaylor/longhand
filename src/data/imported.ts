...
export const IMPORTED: ImportedProblem[] = [
  ...
  {
    input: '-3x - 5y = 13 ; -x + 4y = 10',
    label: '−3x − 5y = 13 ;  −x + 4y = 10',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 7',
  },
  {
    input: '3x + 7y = 1 ; 2x + 4y = 0',
    label: '3x + 7y = 1 ;  2x + 4y = 0',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 8',
  },
  {
    input: '-2x + 5y = 7 ; 2x + 9y = 7',
    label: '−2x + 5y = 7 ;  2x + 9y = 7',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 9',
  },
  {
    input: 'x + 8y = 43 ; 3x - 2y = -1',
    label: 'x + 8y = 43 ;  3x − 2y = −1',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 10',
  },
  {
    input: 'x + 3y = 5 ; 2x + 3y = 4',
    label: 'x + 3y = 5 ;  2x + 3y = 4',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 11',
  },
  {
    input: '3x - 2y = 18 ; 5x + 10y = -10',
    label: '3x − 2y = 18 ;  5x + 10y = −10',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 12',
  },
  {
    input: '4x + 2y = -10 ; 3x + 9y = 0',
    label: '4x + 2y = −10 ;  3x + 9y = 0',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 13',
  },
  {
    input: '2x + 4y = -3.8 ; 9x - 5y = 1.3',
    label: '2x + 4y = −3.8 ;  9x − 5y = 1.3',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 14',
  },
  {
    input: '-2x + 3y = 1.2 ; -3x - 6y = 1.8',
    label: '−2x + 3y = 1.2 ;  −3x − 6y = 1.8',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 15',
  },
  ...
  {
    input: '3x + 5y = 9 ; 30x + 50y = -90',
    label: '3x + 5y = 9 ;  30x + 50y = −90',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 17',
  },
  {
    input: '-3x + y = 2 ; 12x - 4y = -8',
    label: '−3x + y = 2 ;  12x − 4y = −8',
    solverId: 'simultaneous',
    source: 'openstax-alg-trig-2e',
    ref: '§11.1 Ex 18',
  },
  ...
  {
    input: 'C=41.2, a=2.49, b=3.13',
    label: 'γ = 41.2°, a = 2.49, b = 3.13',
  ...
  {
    input: 'B=58.7, a=10.6, c=15.7',
    label: 'β = 58.7°, a = 10.6, c = 15.7',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 8',
  ...
  {
    input: 'C=115, a=18, b=23',
    label: 'γ = 115°, a = 18, b = 23',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 9',
  ...
  {
    input: 'A=119, a=26, b=14',
    label: 'α = 119°, a = 26, b = 14',
    solverId: 'triangle-rules',
    methodId: 'sine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 10',
  ...
  {
    input: 'C=113, b=10, c=32',
    label: 'γ = 113°, b = 10, c = 32',
    solverId: 'triangle-rules',
    methodId: 'sine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 11',
  ...
  {
    input: 'B=67, a=49, b=38',
    label: 'β = 67°, a = 49, b = 38',
    solverId: 'triangle-rules',
    methodId: 'sine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 12',
  ...
  {
    input: 'A=43.1, a=184.2, b=242.8',
    label: 'α = 43.1°, a = 184.2, b = 242.8',
    solverId: 'triangle-rules',
    methodId: 'sine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 13',
  ...
  {
    input: 'B=50, a=105, b=45',
    label: 'β = 50°, a = 105, b = 45',
    solverId: 'triangle-rules',
    methodId: 'sine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 15',
  ...
  {
    input: 'a=42, b=19, c=30',
    label: 'a = 42, b = 19, c = 30  (find an angle)',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 16',
  ...
  {
    input: 'a=14, b=13, c=20',
    label: 'a = 14, b = 13, c = 20  (find an angle)',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 17',
  ...
  {
    input: 'a=16, b=31, c=20',
    label: 'a = 16, b = 31, c = 20  (find an angle)',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 18',
  ...
  {
    input: 'a=13, b=22, c=28',
    label: 'a = 13, b = 22, c = 28  (find an angle)',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 19',
  ...
  {
    input: 'a=108, b=132, c=160',
    label: 'a = 108, b = 132, c = 160  (find an angle)',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 20',
  ...
  {
    input: 'B=88, a=4.4, c=5.2',
    label: 'B = 88°, a = 4.4, c = 5.2',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 22',
  ...
  {
    input: 'C=121, a=21, b=37',
    label: 'C = 121°, a = 21, b = 37',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 23',
  ...
  {
    input: 'a=13, b=11, c=15',
    label: 'a = 13, b = 11, c = 15',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 24',
  ...
  {
    input: 'a=3.1, b=3.5, c=5',
    label: 'a = 3.1, b = 3.5, c = 5',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 25',
  ...
  {
    input: 'a=51, b=25, c=29',
    label: 'a = 51, b = 25, c = 29',
    solverId: 'triangle-rules',
    methodId: 'cosine-rule',
    source: 'openstax-alg-trig-2e',
    ref: '§10.2 Ex 26',
